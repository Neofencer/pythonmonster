...
class MonsterIndex:
    ...
    def display_main(self,dt):
        ...
        level_rect=name_surf.get_frect(bottomleft=top_rect.bottomleft + vector(10,-16))
        self.display_surface.blit(level_surf,level_rect)
        #xp bar
        draw_bar(surface=self.display_surface,
                 rect=pygame.FRect((level_rect.bottomleft[0], level_rect.bottomleft[1] + 5),(100,4)),
                 value=monster.xp,
        ...
        element_rect=name_surf.get_frect(bottomright=top_rect.bottomright + vector(-10,-10))
